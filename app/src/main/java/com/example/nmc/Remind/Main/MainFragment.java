...
import com.example.nmc.Remind.AddToDo.AddToDoActivity;
import com.example.nmc.Remind.AddToDo.AddToDoFragment;
import com.example.nmc.Remind.Analytics.AnalyticsApplication;
import com.example.nmc.Remind.AppDefault.AppDefaultFragment;
import com.example.nmc.Remind.R;
import com.example.nmc.Remind.Reminder.ReminderFragment;
import com.example.nmc.Remind.Settings.SettingsActivity;
import com.example.nmc.Remind.Utility.ItemTouchHelperClass;
import com.example.nmc.Remind.Utility.RecyclerViewEmptySupport;
import com.example.nmc.Remind.Utility.StoreRetrieveData;
import com.example.nmc.Remind.Utility.ToDoItem;
import com.example.nmc.Remind.Utility.TodoNotificationService;
...
public class MainFragment extends AppDefaultFragment {
    private RecyclerViewEmptySupport mRecyclerView; //kiểm tra xem tập dữ liệu cung cấp nguồn cấp dữ liệu của bạn RecyclerView có trống không
    private FloatingActionButton mAddToDoItemFAB; //Nút hành động nổi (FloatingActionButton) là một nút tròn kích hoạt hành động chính trong giao diện người dùng của ứng dụng của bạn.
    private ArrayList<ToDoItem> mToDoItemsArrayList; //Ngoài việc triển khai giao diện Danh sách , lớp này cung cấp các phương thức để thao tác kích thước của mảng được sử dụng nội bộ để lưu trữ danh sách.
    private CoordinatorLayout mCoordLayout; //để thiết kế layout chính của ứng dụng, nó như là phần tử chứa các View con, cung cấp khả năng tương tác mềm dẻo giữa các View con trong nó.
    public static final String TODOITEM = "com.nguyenminhchau.com.nguyenminhchau.minimaltodo.MainActivity";
    ...
    public static final String SHARED_PREF_DATA_SET_CHANGED = "com.nguyenminhchau.datasetchanged";
    public static final String CHANGE_OCCURED = "com.nguyenminhchau.changeoccured";
    private int mTheme = -1;
    private String theme = "name_of_the_theme";
    public static final String THEME_PREFERENCES = "com.nguyenminhchau.themepref";
    public static final String RECREATE_ACTIVITY = "com.nguyenminhchau.recreateactivity";
    public static final String THEME_SAVED = "com.nguyenminhchau.savedtheme";
    public static final String DARKTHEME = "com.nguyenminhchau.darktheme";
    public static final String LIGHTTHEME = "com.nguyenminhchau.lighttheme";
