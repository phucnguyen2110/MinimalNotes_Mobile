package com.example.nmc.Remind.Utility;
...
import com.example.nmc.Remind.Reminder.ReminderActivity;

import java.util.UUID;

public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "com.nmc.todonotificationservicetext";
    public static final String TODOUUID = "com.nmc.todonotificationserviceuuid";
